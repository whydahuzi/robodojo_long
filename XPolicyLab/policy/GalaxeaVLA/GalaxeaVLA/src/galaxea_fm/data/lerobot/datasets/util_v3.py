...
def is_valid_numpy_dtype_string(dtype_str: str) -> bool:
    ...
    NOTE: upstream commented out the `from lerobot.utils.utils import ...` block
    below but still references this helper in validate_feature_dtype_and_shape,
    so it is defined here (copied from datasets/utils.py) to avoid a NameError.
    """
    try:
        np.dtype(dtype_str)
        return True
