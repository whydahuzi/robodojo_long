...
@dataclass
class LigerQwen3VLCausalLMOutputWithPastUpdate(LigerQwen3VLCausalLMOutputWithPast):
...
def lce_forward(
    ...
    **kwargs,
) -> Union[Tuple, LigerQwen3VLCausalLMOutputWithPastUpdate]:
    """
    ...
    return LigerQwen3VLCausalLMOutputWithPastUpdate(
        loss=loss,
        logits=logits,
